package com.huich.roque.app.tuturist_app.adpters;
...
import com.huich.roque.app.tuturist_app.MainActivity;
import com.huich.roque.app.tuturist_app.R;
...
public class PostsRecyclerViewAdapter extends RecyclerView.Adapter<PostsRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mCommentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent commentIntent = new Intent(mContext, MainActivity.class);
